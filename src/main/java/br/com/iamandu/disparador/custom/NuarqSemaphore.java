...
public abstract class NuarqSemaphore implements Semaphore, Constantes, ConstantesJDBC, TablePrefixAware {
    ...
    public NuarqSemaphore(String tablePrefix, String schedName, String defaultSQL, String defaultInsertSQL) {
