...
/**
 * 
 * Customização de org.quartz.impl.jdbcjobstore.StdJDBCConstants
 * 
 * <p>
 ...
 */
public interface ConstantesJDBC extends Constantes {
    ...
    String DELETE_ALL_SIMPLE_TRIGGERS = "DELETE FROM " + TABLE_PREFIX_SUBST + "GATILHO_SIMPLES " + " WHERE " + COL_SCHEDULER_NAME + " = " + SCHED_NAME_SUBST;
    ...
    String DELETE_ALL_CRON_TRIGGERS = "DELETE FROM " + TABLE_PREFIX_SUBST + "GATILHO_CRON" + " WHERE " + COL_SCHEDULER_NAME + " = " + SCHED_NAME_SUBST;
    String DELETE_ALL_BLOB_TRIGGERS = "DELETE FROM " + TABLE_PREFIX_SUBST + "GATILHO_BLOB" + " WHERE " + COL_SCHEDULER_NAME + " = " + SCHED_NAME_SUBST;
    String DELETE_ALL_TRIGGERS = "DELETE FROM " + TABLE_PREFIX_SUBST + "GATILHOS" + " WHERE " + COL_SCHEDULER_NAME + " = " + SCHED_NAME_SUBST;
    String DELETE_ALL_JOB_DETAILS = "DELETE FROM " + TABLE_PREFIX_SUBST + "JOB_DETALHE" + " WHERE " + COL_SCHEDULER_NAME + " = " + SCHED_NAME_SUBST;
    String DELETE_ALL_CALENDARS = "DELETE FROM " + TABLE_PREFIX_SUBST + "CALENDARIO" + " WHERE " + COL_SCHEDULER_NAME + " = " + SCHED_NAME_SUBST;
    String DELETE_ALL_PAUSED_TRIGGER_GRPS = "DELETE FROM " + TABLE_PREFIX_SUBST + "GATILHOS_PAUSADOS" + " WHERE " + COL_SCHEDULER_NAME + " = " + SCHED_NAME_SUBST;
